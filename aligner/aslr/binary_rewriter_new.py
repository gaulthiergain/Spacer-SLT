...
def disassemble(uk, s, use_new_rep):
    ...
    #for k,(v1,v2) in s.data_target.items():
    #    if v1 > 1:
    #        print("LOC: {}: {} ({:x})".format(k,v1, v2))
...
def rewrite_uk(file, json_file, v, rewrite_all, use_new_rep, section=".text.rodata.libkvmfcplat"):
    global verbose
...
def main():
    ...
    rewrite_uk(args.file, args.json, args.verbose, args.rewrite, args.new_rep, args.section)
